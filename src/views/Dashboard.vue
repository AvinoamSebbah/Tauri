...
<template>
    <div class="font-semibold text-3xl mt-1">Welcome, {{ user?.first_name || user?.username || 'User' }}!</div>
    <div class="text-lg mb-3 text-gray-400">ID: <strong>{{ user?.id || 'Unknown' }}</strong></div>
    ...
    <div class="grid grid-cols-12 gap-8">
        ...
        <div class="col-span-12 xl:col-span-6">
            ...
            <div class="card">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div>
                        <Button icon="pi pi-ellipsis-v" class="p-button-text p-button-plain p-button-rounded" @click="($refs.menu2 as any).toggle($event)"></Button>
        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card">
                ...
                <Chart type="bar" :data="chartData as any" :options="chartOptions as any" class="h-80" />
            </div>
            <div class="card">
                <div class="flex items-center justify-between mb-6">
                    <div class="font-semibold text-xl">Notifications</div>
                    <div>
                        <Button icon="pi pi-ellipsis-v" class="p-button-text p-button-plain p-button-rounded" @click="($refs.menu1 as any).toggle($event)"></Button>
