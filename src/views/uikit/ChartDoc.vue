...
const lineData = ref(null) as any;
const pieData = ref(null) as any;
const polarData = ref(null) as any;
const barData = ref(null) as any;
const radarData = ref(null) as any;
const lineOptions = ref(null) as any;
const pieOptions = ref(null) as any;
const polarOptions = ref(null) as any;
const barOptions = ref(null) as any;
const radarOptions = ref(null) as any;
