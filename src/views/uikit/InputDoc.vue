...
const autoValue = ref(null) as any;
const selectedAutoValue = ref(null);
const autoFilteredValue = ref([]) as any;
const calendarValue = ref(null);
const inputNumberValue = ref(null);
const sliderValue = ref(50) as any;
const ratingValue = ref(null) as any;
...
const treeSelectNodes = ref(null) as any;
const selectedNode = ref(null);

onMounted(() => {
    CountryService.getCountries().then((data : any) => (autoValue.value = data));
    NodeService.getTreeNodes().then((data : any) => (treeSelectNodes.value = data));
});
    ...
    <Fluid class="flex flex-col md:flex-row gap-8">
        <div class="md:w-1/2">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <Knob v-model="knobValue" :step="10" :min="-50" :max="50" :valueTemplate="(val) => `${val}%`" />
            </div>
        </div>
        <div class="md:w-1/2">
            <div class="card flex flex-col gap-4">
