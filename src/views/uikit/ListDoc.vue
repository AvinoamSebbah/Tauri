...
const picklistProducts = ref(null) as any;
const orderlistProducts = ref(null) as any;
...
function getSeverity(product : any) {
...
<template>
    <div class="flex flex-col">
        <div class="card">
            ...
            <DataView :value="(products as any)" :layout="(layout as any)" dataKey="id">
                <template #header>
                        ...
                        <div v-for="(item, index) in slotProps.items" :key="index">
                            <div class="flex flex-col sm:flex-row sm:items-center p-6 gap-4" :class="{ 'border-t border-surface': index !== 0 }">
                                <div class="md:w-40 relative">
                                    ...
                                    <Tag :value="item.inventoryStatus" :severity="getSeverity(item) as any" class="absolute dark:!bg-surface-900" style="left: 4px; top: 4px"></Tag>
                                </div>
