...
const customers1 = ref(null) as any;
const customers2 = ref(null) as any;
const customers3 = ref(null) as any;
const filters1 = ref(null) as any;
const loading1 = ref(null) as any;
const balanceFrozen = ref(false) as any;
const products = ref(null) as any;
...
function getStockSeverity(product : any) {
...
onBeforeMount(() => {
    ...
    CustomerService.getCustomersLarge().then((data : any) => {
        ...
        customers1.value.forEach((customer : any) => (customer.date = new Date(customer.date)));
    });
...
function calculateCustomerTotal(name : any) {
    let total = 0;
    if (customers3.value) {
    ...
    <div class="card">
        ...
        <!-- :filters="filters1" -->
            ...
            <Column header="Status" field="status" :filterMenuStyle="{ width: '14rem' }" style="min-width: 12rem">
                <template #body="{ data }">
                    <Tag :value="data.status" :severity="getSeverity(data.status) as any" />
                </template>
                <template #filter="{ filterModel }">
                    <Select v-model="filterModel.value" :options="statuses" placeholder="Select One" showClear>
                        <template #option="slotProps">
                            <Tag :value="slotProps.option" :severity="getSeverity(slotProps.option) as any" />
                        </template>
                    </Select>
                </template>
            </Column>
    ...
    <div class="card">
        ...
        <DataTable v-model:expandedRows="expandedRows" :value="products" dataKey="id" tableStyle="min-width: 60rem">
            ...
            <Column header="Status">
                <template #body="slotProps">
                    <Tag :value="slotProps.data.inventoryStatus" :severity="getStockSeverity(slotProps.data) as any" />
                </template>
            </Column>
                ...
                <div class="p-4">
                    ...
                    <DataTable :value="slotProps.data.orders">
                        ...
                        <Column field="status" header="Status" sortable>
                            <template #body="slotProps">
                                <Tag :value="slotProps.data.status.toLowerCase()" :severity="getOrderSeverity(slotProps.data) as any" />
                            </template>
                        </Column>
    ...
    <div class="card">
        ...
        <DataTable :value="customers3" rowGroupMode="subheader" groupRowsBy="representative.name" sortMode="single" sortField="representative.name" :sortOrder="1" scrollable scrollHeight="400px" tableStyle="min-width: 50rem">
            ...
            <Column field="status" header="Status" style="min-width: 200px">
                <template #body="slotProps">
                    <Tag :value="slotProps.data.status" :severity="getSeverity(slotProps.data.status) as any" />
                </template>
            </Column>
            <Column field="date" header="Date" style="min-width: 200px"></Column>
